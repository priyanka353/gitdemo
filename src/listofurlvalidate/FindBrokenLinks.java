...
public class FindBrokenLinks 
{
    ...
    public void setUp() throws InterruptedException {
    	System.setProperty("webdriver.chrome.driver", "E:\\priyanka\\chromedriver_win32\\chromedriver.exe");
	    driver=new ChromeDriver();
		driver.get("https://kyc.dhlecommerce.com/login");
		Thread.sleep(2000);
